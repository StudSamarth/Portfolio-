      ...
      <div className="container px-8 mx-auto md:px-16 lg:px-24">
        <div className="flex flex-col items-center mb-4 md:flex-row md:space-x-12">
          <div className="flex-1 mb-4 md:mb-0">
            <h3 className="mb-2 text-2xl font-bold">SAM</h3>
            <p className="text-gray-400">
              Full-Stack Developer (MERN) specializing in web and
        ...
        >
          ...
          <div className="flex my-4 space-x-4 md:my-0">
            ...
            <a href="https://x.com/Stud_Samarth" target="_blank" className="text-gray-400 hover:text-white">
              <FaTwitter />
            </a>
            <a href="https://www.linkedin.com/in/samarth-mehta-1a5857251" target="_blank" className="text-gray-400 hover:text-white">
              <FaLinkedin />
            </a>
            <a href="https://github.com/StudSamarth" target="_blank" className="text-gray-400 hover:text-white">
              <FaGithub />
            </a>
          </div>
